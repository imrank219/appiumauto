...
public class ACCOUNT_SETTINGS_View_Terms extends BasicIOSTest {
    @Test
    public void ViewTermsTest() throws IOException, InterruptedException {
       ...
       // driver2.context((String) contextNames.toArray()[1]);
